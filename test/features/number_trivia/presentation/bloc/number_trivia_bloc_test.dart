...
void main() {
  ...
  group('GetTriviaForConcreteNumber', () {
    ...
    test('should call InputConverter to validate and convert string to unsigned integer',
    () async {
      //arrange
    ...
    test('should get data from concrete use case',
    () async {
      //arrange
      setUpMockInputConverterSucces();
    ...
    test('should emit [Loading, Error] with proper message for error when getting data fails',
    () async {
      //arrange
      setUpMockInputConverterSucces();
  ...
  group('GetTriviaForRandomNumber', () {
    ...
    test('should get data from random use case',
    () async {
      //arrange
