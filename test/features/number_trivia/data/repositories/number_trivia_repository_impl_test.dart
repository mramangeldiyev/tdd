...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    test('should check device online or not', () async {
      //arrange
      when(mockNetworkInfo.isConnected).thenAnswer((_) async => true);
      //act
    ...
    runTestsOnline(() {
      ...
      test('should return remote data when call to remote data source is succesfull',
      () async{
        //arrange
      ...
      test('should cache data locally when call to remote data source is succesfull',
      () async{
        //arrange
        when(mockRemoteDataSource.getConcreteNumberTrivia(any)).thenAnswer((_) async => tNumberTriviaModel);
        //act
    ...
    test('should return server failure when call to remote data source is unsuccesfull',
      () async{
        //arrange
